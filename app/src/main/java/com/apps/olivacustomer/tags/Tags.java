package com.apps.olivacustomer.tags;

public class Tags {

    public static String base_url = "http://olivaksa.com/";
    public static final String IMAGE_Product_URL = "http://olivaksa.com/public/images/product/";
    public static final String IMAGE_Slider_URL = base_url + "assets/images/sliders/";//type=1
    public static final String IMAGE_Maincategory_URL = "http://olivaksa.com/public/images/category/";//type=2
    ...
    public static final String not_tag = "olivacustomer_not";
    //appolivacustomer@gmail.com
